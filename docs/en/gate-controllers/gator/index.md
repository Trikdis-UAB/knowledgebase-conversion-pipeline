...
+===============+====================+========================================+
| OUTPUT*STATE#  | Output control      | Output control command (turn on/turn off; turn on/turn off for pulse time).|
|                |                     |                                         |
...
|                |                     |                                         |
|                |                     | (output pulse time can be set using the TrikdisConfig program, in the Input/Output settings table)|
|                |                     |                                         |
...
|                |                     |                                         |
|                |                     | E.g. (turn on input 4 for pulse time): 4*3#|
+---------------+--------------------+----------------------------------------+
